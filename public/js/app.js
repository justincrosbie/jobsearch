window.app = angular.module('jobsearch', ['ngCookies', 'ngResource', 'ui.bootstrap', 'ui.select2', 'ui.calendar', 'ui.map',
                                        'ngTable', '$strap.directives', 'ngRoute', 'ngAnimate', 
...
window.angular.module('ngff.controllers', 
										[
                                            ...
                                            'ngff.controllers.calendar', 
                                            'ngff.controllers.map', 
											'ngff.controllers.titles', 
											'ngff.controllers.categorys', 
											'ngff.controllers.industrys', 
											'ngff.controllers.states', 
											'ngff.controllers.countrys', 
											'ngff.controllers.employers', 
											'ngff.controllers.sites', 
											'ngff.controllers.jobs', 
											'ngff.controllers.applicants' 
...
window.angular.module('ngff.services',
										[
											...
											'ngff.services.categorys', 
											'ngff.services.industrys', 
											'ngff.services.states', 
											'ngff.services.countrys', 
											'ngff.services.employers', 
											'ngff.services.sites', 
											'ngff.services.jobs', 
											'ngff.services.applicants' 
